...
| `body-html`                   | HTML body (formatted)             | `text/html` response. Formatted view re-indents and syntax-highlights the markup (PRO-414), virtualized line-by-line.                                             |
| `body-xml`                    | XML body (formatted)              | `application/xml` SOAP response. Formatted view re-indents and syntax-highlights the XML (PRO-414), virtualized line-by-line.                                     |
| `body-binary`                 | Binary body                       | `application/octet-stream` response. Body pane shows "Binary data · N bytes" lifecycle state.                                                                     |
| `body-image`                  | Image body (PNG)                  | `image/png` response. Body pane renders the decoded bytes inline as an `<img>` element in Rendered mode (PRO-412).                                                |
