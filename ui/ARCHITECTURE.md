...
ui/
  src/
    ...
    components/     # App-owned content components (BodySplit, BodyPane, LiveIndicator, StreamErrorBanner, HeadersSplit, HeadersPane, JsonViewer, TimingView, CopyButton)
      protospy/     # live v2.4 shell/chrome + list/inspector scaffolds: app-shell, top/filter/status/list bars, command palette, shortcuts overlay, exchange table/rows, grouped traces, stream/event-log views, method/status/connection atoms
