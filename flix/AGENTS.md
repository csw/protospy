...
To inspect network traffic during browser tests, prefer the harness's native
network-inspection tool when one is available. Otherwise use Playwright/browser
tooling rather than injecting JavaScript event listeners.
